...
public class EnrichMediatorDeserializer extends AbstractEsbNodeDeserializer<AbstractMediator, EnrichMediator> {
    ...
    public EnrichMediator createNode(IGraphicalEditPart part, AbstractMediator mediator) {
        ...
        Assert.isTrue(mediator instanceof org.apache.synapse.mediators.elementary.EnrichMediator,
        ...
        org.wso2.developerstudio.eclipse.gmf.esb.EnrichMediator visualEnrichMediator = (org.wso2.developerstudio.eclipse.gmf.esb.EnrichMediator) DeserializerUtils
            ...
            case org.apache.synapse.mediators.elementary.EnrichMediator.INLINE:
                ...
                if (source.getInlineOMNode() != null) {
                    ...
                    executeSetValueCommand(visualEnrichMediator.getInlineRegistryKey(),
                            REGISTRY_KEY_PROPERTY__KEY_VALUE, source.getInlineKey());
